      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            >
              <div className={`p-2 rounded-xl ${fundSource === 'outside' ? 'bg-purple-600 text-white shadow-xs' : 'bg-white border border-slate-200 text-slate-600'}`}>
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  <span className={`text-xs font-black ${fundSource === 'outside' ? 'text-purple-950' : 'text-slate-800'}`}>
                    Outside / Sponsor
                  </span>
                  {fundSource === 'outside' && (
