...
import { ConfirmModal, FormattedText, Button, EmptyState, StatusBadge, useToast, ActionMenu } from '@/components'
                        ...
                        },
                        {
                          ...
                          items: [
                            ...(f.status === 'published' ? [
                              ...
                              {
                                label: f.status === 'draft' ? 'Publish Form' : 'Reopen Form',
