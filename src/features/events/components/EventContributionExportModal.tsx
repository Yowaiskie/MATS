...
export const EventContributionExportModal: React.FC<EventContributionExportModalProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Export Event Contributions Report PDF" maxWidth="2xl">
      <div className="space-y-5 max-h-[75vh] overflow-y-auto pr-1 text-xs">
        ...
        <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-3">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <div>
              <h4 className="text-xs font-black text-slate-800 uppercase tracking-tight">{eventName}</h4>
