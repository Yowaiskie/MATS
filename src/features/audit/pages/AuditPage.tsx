...
export const AuditPage: React.FC = () => {
  ...
  const actions: AuditAction[] = [
    ...
    'REQUEST_CANCEL', 'REQUEST_VOID', 'FUNDS_RELEASE', 'LIQUIDATION_SUBMIT', 'LIQUIDATION_APPROVE', 'LIQUIDATION_REVISION_REQUEST', 'LIQUIDATION_REOPEN', 'REQUEST_ARCHIVE', 'REQUEST_RESTORE', 'REQUEST_DELETE',
  ...
  const actionColors: Record<AuditAction, string> = {
    ...
    LIQUIDATION_REVISION_REQUEST: 'bg-amber-100 text-amber-800 border-amber-200',
    LIQUIDATION_REOPEN: 'bg-orange-100 text-orange-800 border-orange-200',
