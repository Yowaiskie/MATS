          ...
          <div className="flex items-center justify-between pb-3 border-b border-slate-100 bg-white">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h3 className="text-base font-black text-slate-900 tracking-tight">Schedule Templates Manager</h3>
                <p className="text-xs font-semibold text-slate-500 mt-0.5">Manage recurring schedule templates and bulk-generate schedules.</p>
              </div>
            </div>
            <button 
              type="button"
              ...
              className="text-slate-400 hover:text-slate-600 p-1.5 rounded-xl hover:bg-slate-100 transition-colors cursor-pointer focus:outline-none relative z-30"
